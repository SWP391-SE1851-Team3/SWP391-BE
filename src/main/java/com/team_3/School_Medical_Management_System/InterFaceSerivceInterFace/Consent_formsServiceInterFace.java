...
public interface Consent_formsServiceInterFace {
    ...
    public SendConsentFormResult  sendConsentFormsByClassName(String className, Integer batchId, LocalDateTime sendDate, LocalDateTime expireDate,String status);
